...
with_node \
  ...
  --target "/Users/rconwell/my-health-app/my-health-app-clean/ios/Pods/Target Support Files/Pods-myhealthappclean/ExpoModulesProvider.swift" \
  --entitlement "/Users/rconwell/my-health-app/my-health-app-clean/ios/myhealthappclean/myhealthappclean.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-clipboard" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-keep-awake"
